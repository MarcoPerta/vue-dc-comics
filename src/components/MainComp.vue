  ...
  <div class="container-full">
    ...
    <div class="container">
        ...
        <div class="container-cards">
            <div class="cards">
                <FumettoCard v-for="(elem,index) in products" :key="index" :dettagliProdotto="elem"/>
            </div>
        </div>
    </div>
...
<script>
import MainShopBlue from './MainShopBlue.vue'
import FumettoCard from './FumettoCard.vue'
